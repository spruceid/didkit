...
* @returns {string}
*/
export function pubkeyToDID(method_pattern: string, pubkey_hex: string): string;
/**
* @param {string} did
* @returns {Promise<any>}
*/
...
* @returns {string}
*/
export function finalizeCredential(signing_input: string, signature: string): string;
/**
* @param {string} credential
* @param {string} proof_options
* @param {string} key
